...
public class ExecutorStats implements org.apache.thrift.TBase<ExecutorStats, ExecutorStats._Fields>, java.io.Serializable, Cloneable, Comparable<ExecutorStats> {
  ...
  public ExecutorStats(ExecutorStats other) {
    ...
    if (other.is_set_e2e_transferred()) {
        Map<String,Map<String,Long>> __this__e2e_transferred = new HashMap<String,Map<String,Long>>(other.e2e_transferred.size());
        for (Map.Entry<String, Map<String,Long>> other_element : other.e2e_transferred.entrySet()) {
          ...
          Map<String,Long> __this__e2e_transferred_copy_value = new HashMap<String,Long>(other_element_value);

          __this__e2e_transferred.put(__this__e2e_transferred_copy_key, __this__e2e_transferred_copy_value);
        }
        this.transferred = __this__e2e_transferred;
      }
...
public ExecutorSpecificStats get_specific() {
  ...
  public int hashCode() {
    ...
    list.add(present_e2e_transferred);
    if (present_e2e_transferred)
      list.add(e2e_transferred);
  ...
  private static class ExecutorStatsStandardScheme extends StandardScheme<ExecutorStats> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
                {
                  ...
                  struct.e2e_transferred = new HashMap<String,Map<String,Long>>(2*_map266.size);
                  String _key267;
                  ...
                  for (int _i269 = 0; _i269 < _map266.size; ++_i269)
                  {
                	  _key267 = iprot.readString();
                    {
                      ...
                      String _key271;
                      long _val272;
                      for (int _i265 = 0; _i265 < _map270.size; ++_i265)
                      {
                    ...
                    struct.e2e_transferred.put(_key267, _val268);
                  }
                  iprot.readMapEnd();
                }
                struct.set_e2e_transferred_isSet(true);
              } else { 
                org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
              }
              break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ExecutorStats struct) throws org.apache.thrift.TException {
      ...
      if (struct.transferred != null) {
          ...
          {
            oprot.writeMapBegin(new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.MAP, struct.e2e_transferred.size()));
            for (Map.Entry<String, Map<String,Long>> _iter270 : struct.e2e_transferred.entrySet())
            {
  ...
  private static class ExecutorStatsTupleScheme extends TupleScheme<ExecutorStats> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, ExecutorStats struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      {
        ...
        for (Map.Entry<String, Map<String,Long>> _iter272 : struct.emitted.entrySet())
        {
      ...
      }
      {
        ...
        for (Map.Entry<String, Map<String,Long>> _iter274 : struct.transferred.entrySet())
        {
      ...
      {
          oprot.writeI32(struct.e2e_transferred.size());
          for (Map.Entry<String, Map<String,Long>> _iter276 : struct.e2e_transferred.entrySet())
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, ExecutorStats struct) throws org.apache.thrift.TException {
      ...
      
      {
          ...
          struct.e2e_transferred = new HashMap<String,Map<String,Long>>(2*_map290.size);
          String _key291;
          ...
          for (int _i293 = 0; _i293 < _map290.size; ++_i293)
          {
            ...
            struct.e2e_transferred.put(_key291, _val292);
          }
        }
      struct.set_e2e_transferred_isSet(true);
      struct.specific = new ExecutorSpecificStats();
